...
2. By using the `ConVar` provided by this plugin, you can control which situations in `(1)` to issue reminders in
   ...
   |-------------------------|-----|---------------|
   | sm_notice_bleedout | 1 | Prompt the player to bleed in the chat box |
   | sm_notice_became_infected | 1 | Prompt the player to be infected in the chat box |
...
This plugin is equivalent to an upgraded version
